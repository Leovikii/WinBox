...
<template>
  <div class="h-screen w-screen relative bg-[#090909] text-white select-none overflow-hidden font-sans flex flex-col">
    ...
    <div :class="['absolute inset-0 pt-20 px-6 pb-8 flex flex-col justify-between items-center transition-all duration-500', isDrawerOpen ? 'scale-95 opacity-50 blur-[2px]' : 'scale-100 opacity-100']">
      <DashboardControl
