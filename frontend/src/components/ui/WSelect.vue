...
const buttonClasses = computed(() => {
  const classes = [
    'w-full relative bg-white/[0.07] text-[11px] text-gray-300 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]',
  ...
  if (props.disabled) {
    classes.push('opacity-60 cursor-not-allowed hover:bg-white/[0.07] hover:border-white/10')
  }
...
const dropdownClasses = computed(() => {
  const classes = [
    'fixed z-[9999] bg-[#242424] border border-white/10 rounded-md overflow-hidden',
      ...
      >
        <div
          ...
          :class="[
            ...
            'hover:bg-white/[0.12] hover:text-[var(--accent-color)]',
